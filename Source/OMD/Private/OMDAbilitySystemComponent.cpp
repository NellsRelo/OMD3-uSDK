...
void UOMDAbilitySystemComponent::Server_HasVisualStatusEffect_Implementation(FGuid request, AOMDCharacter* Target, EStatusEffectCategory categoryToCheck) {
}
bool UOMDAbilitySystemComponent::Server_HasVisualStatusEffect_Validate(FGuid request, AOMDCharacter* Target, EStatusEffectCategory categoryToCheck) {
    return true;
}
...
void UOMDAbilitySystemComponent::Client_HasVisualStatusEffect_Implementation(FGuid request, int32 ID) {
}
...
UOMDAbilitySystemComponent::UOMDAbilitySystemComponent() {
