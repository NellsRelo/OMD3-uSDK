...
//CROSS-MODULE INCLUDE V2: -ModuleName=NavPower -ObjectName=NavPowerPlayerMovementComponent -FallbackName=NavPowerPlayerMovementComponent
...
AOMDPlayerCharacter::AOMDPlayerCharacter() {
