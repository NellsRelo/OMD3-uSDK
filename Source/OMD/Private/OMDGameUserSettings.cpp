...
UOMDGameUserSettings::UOMDGameUserSettings() {
    ...
    this->bLeaderboardOptOut = false;
    this->bPlayScenarioDialogue = true;
    this->bShowClosedCaptioning = true;
    this->MasterVolumeModifier = 0.57f;
    this->MusicVolumeModifier = 0.35f;
    this->EffectsVolumeModifier = 0.76f;
    this->VoiceVolumeModifier = 1.00f;
